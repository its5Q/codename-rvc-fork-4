...
from rvc.lib.algorithm.residuals import ResBlock, ResBlock_Snake_Fused, ResBlock_SnakeBeta, ResBlock_PReLU
...
class HiFiGANNSFGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        self.alphas.append(torch.nn.Parameter(torch.ones(1, upsample_initial_channel, 1)))
        ...
        for i, (u, k) in enumerate(zip(upsample_rates, upsample_kernel_sizes)):
            ...
            self.alphas.append(torch.nn.Parameter(torch.ones(1, channels[i], 1)))
